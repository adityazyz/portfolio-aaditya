...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 overflow-visible max-w-[90vw] [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className
      )}
    >
      <ul
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[166px] mx-1 relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 "
            style={{
              background:
