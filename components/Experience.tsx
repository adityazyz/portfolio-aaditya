    ...
    <div className="bg-black   w-full h-fit py-14 sm:py-24 md:py-44 pb-10 md:pb-32">
      <div>
        ...
        <motion.div
          ...
          className="w-full px-8 md:px-16 text-center text-white font-light tracking-wider text-[15px] md:text-lg flex mb-10 sm:pb-24 justify-center mt-12 md:mt-24 "
        >
          {descriptionTop}
        </motion.div>
        ...
        <motion.div
          ...
          className="w-full px-8 tracking-wider md:px-16 text-center text-white font-light  text-[15px] md:text-lg flex mb-16 justify-center mt-4 md:mt-20 "
        >
          {descriptionBottom}
        </motion.div>
      </div>
